...
# This script can be used to download a firmware image
# onto the SAMD20 chip using OpenOCD.

rake release
./create_raw_binary.sh

TARGET=build/release/GccGenD20.bin
LOAD_ADDRESS=0x0
...
echo reset run | nc localhost ${OPENOCD_SERVER_PORT}
echo halt | nc localhost ${OPENOCD_SERVER_PORT} 
